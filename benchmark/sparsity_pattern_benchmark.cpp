...
int main(int argc, char **argv) {
    ...
    for (int i = 1; i <= 160;  i += 15) {
        ...
        simple_sparstiy_pattern_average_time += simple_sparstiy_pattern_time / config.iters;
        ...
        global_sparstiy_pattern_average_time += global_sparstiy_pattern_time / config.iters;
        ...
        column_sparstiy_pattern_average_time += column_sparstiy_pattern_time / config.iters;
        ...
        lflil_sparstiy_pattern_average_time += lfil_sparstiy_pattern_time / config.iters;
